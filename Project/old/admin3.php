        ...
        <table>
            ...
            <tbody id="reservation-body">
                ...
                while($row = $result->fetch_assoc())
                {
                    ...
                    <td>" . $row["time"] . "</td>
                    <td>
                    <a class = 'accept' href= 'accept.php?id=$row[id]&name=$row[name]&email=$row[email]&address=$row[address]&cnum=$row[cnum]&date=$row[date]&time=$row[time]'>Accept</a>
                    <a class = 'reject' href= 'reject.php?id=$row[id]&name=$row[name]&email=$row[email]&address=$row[address]&cnum=$row[cnum]&date=$row[date]&time=$row[time]'>Reject</a>
                    </td>
                    </tr>";
