        ...
        <div class="content">
            ...
            <div class="table-container">
                ...
                while($row = $result->fetch_assoc())
                {
                    ...
                    <td>
                    <a class = 'accept' id = 'accept' onclick = 'accept()' href= 'accept.php?id=$row[id]&name=$row[name]&email=$row[email]&address=$row[address]&cnum=$row[cnum]&date=$row[date]&time=$row[time]'><strong>Accept</strong></a>
                    <a class = 'decline' id = 'reject' onclick = 'reject()' href= 'reject.php?id=$row[id]&name=$row[name]&email=$row[email]&address=$row[address]&cnum=$row[cnum]&date=$row[date]&time=$row[time]'><strong>Reject</strong></a>
                    </td>
                    </tr>";
                }
