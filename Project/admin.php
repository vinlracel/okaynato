        ...
        <div class="content">
            ...
            <div class="table-container">
                ...
                while($row = $result->fetch_assoc())
                {
                    ...
                    <a class = 'decline' href= 'reject.php?id=$row[id]&name=$row[name]&email=$row[email]&address=$row[address]&cnum=$row[cnum]&date=$row[date]&time=$row[time]'><strong>Reject</strong></a>
                    </td>
                    </tr>";
                }
